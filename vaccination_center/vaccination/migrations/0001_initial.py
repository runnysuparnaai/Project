...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='m_vaccination_center',
            fields=[
                ('record_key', models.CharField(max_length=100, primary_key=True, serialize=False)),
                ...
                ('active_to', models.DateTimeField(default=django.utils.timezone.now)),
        ...
        migrations.CreateModel(
            name='m_vaccination_center_history',
            fields=[
                ('record_key', models.CharField(max_length=100, primary_key=True, serialize=False)),
                ('code', models.CharField(max_length=100)),
